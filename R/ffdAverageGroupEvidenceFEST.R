...
#' @name ffdAverageGroupEvidenceFETS
#' @title ffdAverageGroupEvidenceFETS
#' @description 
#' descripcion de la funcion ffdAverageGroupEvidenceFETS TODO
#' @details
...
#' @export
ffdAverageGroupEvidenceFETS <- function(ffdGroup, covariates, m0=0, Cova=100,
  ...
  ffd.out <- pbapply::pbapply(posiffd, 1, ffdAverageGroupVoxelFETS, ffdGroup, covariates, m0, Cova,
