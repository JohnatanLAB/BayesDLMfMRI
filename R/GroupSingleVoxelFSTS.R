...
#' @description
#' descripcion de la funcion GroupSingleVoxelFSTS TODO
#' @details
#' detalles de uso de la funcion TODO
#' @param posi.ffd  por definir
#' @param DatabaseGroup  por definir
...
#' @param Ncores a postive integer indicating the number of threads or cores to be used in the computation of the activation maps. TODO
