#' @name ffdAverageGroupEvidenceFFBS
#' @title ffdAverageGroupEvidenceFFBS 
#' @description 
#' descripcion de la funcion ffdAverageGroupEvidenceFFBS TODO
#' @details
...
#' @export
ffdAverageGroupEvidenceFFBS <- function(ffdGroup, covariates, m0=0, Cova=100,
  ...
  ffd.out <- pbapply::pbapply(posiffd, 1, ffdAverageGroupVoxelFFBS, ffdGroup, covariates, m0, Cova,
