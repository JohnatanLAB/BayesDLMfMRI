#' @name ffdAverageGroupEvidenceFSTS
#' @title ffdAverageGroupEvidenceFSTS 
#' @description 
#' descripcion de la funcion ffdAverageGroupEvidenceFSTS TODO
#' @details
...
#' @export
ffdAverageGroupEvidenceFSTS <- function(ffdGroup, covariates, m0=0, Cova=100,
  ...
  ffd.out <- pbapply::pbapply(posiffd, 1, ffdAverageGroupVoxelFSTS, ffdGroup, covariates, m0, Cova,
