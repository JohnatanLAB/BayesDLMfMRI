...
#' @description
#' descripcion de la funcion GroupSingleVoxelFFBS TODO
#' @details
#' detalles de uso de la funcion
#' @param posi.ffd  por definir TODO
#' @param DatabaseGroup  por definir TODO
...
#' @return Produces some usefull outputs from a single voxel analysis related to the FFBS algorithm
#' @examples TODO
#' @export
GroupSingleVoxelFFBS <- function(posi.ffd, DatabaseGroup, 
                                 covariates, m0, Cova, 
                                 delta, S0, n0, N1, Nsimu1, 
                                 r1, Test, Cutpos){
